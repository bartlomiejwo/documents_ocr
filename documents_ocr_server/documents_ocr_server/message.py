...
class Message:
    ...
    @staticmethod
    def get_connections_limit_exceeded_message_bytes(encoding, header_size_in_bytes, header_byte_order):
        message = Message()

        return message.to_bytes(
            Message.CONTENT_TYPE_COMMAND,
            Command.CONNECTIONS_LIMIT_EXCEEDED,
            encoding,
            header_size_in_bytes,
            header_byte_order
        )
    ...
    @staticmethod
    def get_connection_accepted_message_bytes(encoding, header_size_in_bytes, header_byte_order,
                                                available_spots):
        message = Message()
        info = {
    ...
    @staticmethod
    def get_file_ocr_response_message_bytes(ocr_file_bytes, encoding, header_size_in_bytes,
            header_byte_order, pages_text):
        message = Message()
        info = {
            'action': Response.FILE_OCR,
            'pages': pages_text,
        }
    ...
    @staticmethod
    def get_test_response_message_bytes(encoding, header_size_in_bytes, header_byte_order):
        message = Message()
        info = {
            'action': Response.TEST_MESSAGE,
        }
    ...
    @staticmethod
    def get_server_error_message_bytes(text, encoding, header_size_in_bytes, header_byte_order):
        message = Message()
        info = {
            'action': Response.SERVER_ERROR,
        }
